" Vim color file
"
" Code Tool by Martijn Pepping <martijn@xbsd.nl>
"
" Converted from the Code School theme from http://astonj.com
...
hi LineNr ctermfg=102 ctermbg=23 cterm=NONE guifg=orange guibg=#2a343a gui=NONE
hi VertSplit ctermfg=59 ctermbg=59 cterm=NONE guifg=#252c31 guibg=#252c31 gui=NONE
hi MatchParen ctermfg=180 ctermbg=NONE cterm=underline guifg=#68a9eb guibg=NONE gui=inverse
...
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=inverse
